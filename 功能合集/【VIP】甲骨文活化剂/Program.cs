...
namespace Oracle
{
    ...
    internal static class Program
    {
        ...
        private static void OnGameLoad(EventArgs args)
        {
            ...
            Origin = new Menu("【超神汉化】甲骨文活化剂", "oracle", true);
            ...
            Origin.AddItem(
                new MenuItem("ComboKey", "热键 (激活)")
                    .SetValue(new KeyBind(32, KeyBindType.Press)));
			Origin.AddItem(new MenuItem("system", "超神汉化"));
			...
			Game.PrintChat("<font color=\"#FFFF00\">瓒呯姹夊寲");
          
			Game.PrintChat("<font color=\"#FFFF00\">L#姹夊寲缇わ細386289593");
