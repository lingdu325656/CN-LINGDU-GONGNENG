...
{{
    ...
    {{
        ...
        private readonly Menu _SimpleTSMenu;

        public MenuWrapper(string menuName, bool addSimpleTS = true, bool addOrbwalker = true)
        {{
            // Create menu
            ...
            {{
                // Target selector
                _SimpleTSMenu = new Menu("Target Selector", ts");
                SimpleTS.AddToMenu(_SimpleTSMenu);
                _menu.AddSubMenu(_SimpleTSMenu);
            }
        ...
        public Menu SimpleTSMenu
        {{
            get {{ return _SimpleTSMenu; }
        }
